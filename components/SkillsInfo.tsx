  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="group relative w-fit">
        <div className="rounded-xl border border-neutral-300 bg-zinc-100 p-1 duration-200 ease-in-out hover:border-neutral-400 hover:bg-zinc-200 dark:border-neutral-800 dark:bg-zinc-900 dark:hover:bg-zinc-800">
          <div className="mx-2 my-1 flex flex-col items-center justify-center gap-1">
            <Image
